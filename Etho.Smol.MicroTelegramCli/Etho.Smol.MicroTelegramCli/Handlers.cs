...
namespace Etho.Smol.MicroTelegramCli
{
    public static class Handlers
    {
        ...
        private static async Task BotOnMessageReceived(ITelegramBotClient botClient, Message message)
        {
            ...
            {
                Console.WriteLine($"{message.From?.Username}: {message.Type}");
                return;
            }
            else
            {
        ...
        public static async Task<Message> Say(string whatToSay)
        {
            return await _botClient.SendTextMessageAsync(chatId: _chatId,
                                                        text: whatToSay,
                                                        replyMarkup: new ReplyKeyboardRemove());
        }
    }
